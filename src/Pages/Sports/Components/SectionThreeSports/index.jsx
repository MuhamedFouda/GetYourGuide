...
export default function SectionThrerSports() {
  ...
  return (
    <div className='sectionThreeSports'>
    ...
    >
        ...
        <SwiperSlide className='swiperSlide'> 
        <div>
          <img src='https://cdn.getyourguide.com/img/location/533597cb7cfd9.jpeg/86.jpg'/>
          <div className='swiperSlideText'>
            <h5>Boston</h5>
          </div>
        </div>
        ...
        <SwiperSlide className='swiperSlide'> 
        <div>
          <img src='https://cdn.getyourguide.com/img/location/5ffeb50d6a2b9.jpeg/86.jpg'/>
          <div className='swiperSlideText'>
            <h5>Munich</h5>
          </div>
        </div>
