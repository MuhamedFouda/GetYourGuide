...
export default function SectionOneCulture() {
    ...
    axios.get("http://localhost:3000/CultureSectionOne").then((ele) => {
        setcard(ele.data)
    })
    return (
        <div className='sectionOneCulture wow animate__animated animate__zoomInDown'>
